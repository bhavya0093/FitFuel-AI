/* ==========================================================================
   FitFuel AI Seller Portal - Advanced Dark Mode Controller
   File: seller_theme.js
   ========================================================================== */
...
(function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const themeToggleBtn = document.getElementById("seller-theme-toggle-btn");
            ...
            if (themeToggleBtn) {
                ...
                if (icon) {
                    if (isDark) {
                        ...
                        themeToggleBtn.style.color = "#64748B";
                    }
                }
            }
